...
def _node_signature(graph: WorldGraph, node_id: str) -> dict[tuple[str, str], int]:
    ...
    # Iterate over actual out/in edges rather than all relations in the graph.
    # This reduces complexity from O(|Relations|) to O(Degree), avoiding
    # overhead for nodes with sparse connectivity.
