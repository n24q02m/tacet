...
if _HAS_FASTAPI:
    ...
    class AskRequest(BaseModel):
        head: Annotated[str, Field(max_length=256)]
        relation: Annotated[str, Field(max_length=256)]
    ...
    class DistillRequest(BaseModel):
        head: Annotated[str, Field(max_length=256)]
        relation: Annotated[str, Field(max_length=256)]
        answers: Annotated[list[Annotated[str, Field(max_length=256)]], Field(max_length=10000)]
