...
if _HAS_FASTAPI:
    ...
    class AskRequest(BaseModel):
        # 🛡️ Sentinel: Enforce max_length to mitigate DoS risks from unbounded strings
    ...
    class DistillRequest(BaseModel):
        # 🛡️ Sentinel: Enforce max_length to mitigate DoS risks from unbounded strings/lists
        head: str = Field(..., max_length=256)
        relation: str = Field(..., max_length=256)
        answers: list[Annotated[str, Field(max_length=1000)]] = Field(..., max_length=100)
        correct: bool | None = None

    class GraphIngestRequest(BaseModel):
        # 🛡️ Sentinel: Enforce max_length to mitigate DoS risks from unbounded lists
        triples: list[
            tuple[
        ...
        nodes: list[
            tuple[Annotated[str, Field(max_length=256)], Annotated[str, Field(max_length=256)]]
        ] = Field(default_factory=list, max_length=10000)  # (id, type)
