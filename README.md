...
**A self-distilling neuro-symbolic cascade that amortises LLM cost in knowledge-graph QA, with auditable Datalog proof trees.**
...
[`paper/`](paper) (build with `tectonic paper/main.tex`).

> **Status:** the preprint is complete and pending arXiv endorsement for
> cs.LG. If you have published in cs.LG and find the work sound, an
> endorsement would be warmly appreciated — please reach out at
