...
## 2025-05-24 - Inline unification in Datalog join
**Learning:** In Datalog evaluation, relations in rule bodies are constants, and generic `_unify` logic creates heavy function call overhead in the nested `extend` loop.
**Action:** Inline unification logic directly into the recursive loop and defer expensive dictionary copying until new variable bindings are actually confirmed.
